...
class _PedidosProfissionalScreenState
  ...
  List<MockPedidoProfissional> get _filtrados {
    if (_filtro == 'Todos') return pedidosProfissionalMock;
    final map = {
    ...
    return pedidosProfissionalMock
        .where((p) => p.status == map[_filtro])
        .toList();
  }
              ...
              : SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, i) =>
                          _CardPedido(pedido: _filtrados[i], onUpdate: () => setState(() {})),
...
class _CardPedido extends StatefulWidget {
  ...
  const _CardPedido({required this.pedido, required this.onUpdate});
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.person_rounded, color: cor, size: 24),
                    ),
