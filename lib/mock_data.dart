 ...
 class ClienteLogado {
  static String nome = 'Lucas Oliveira';
  static String email = 'lucas.oliveira@email.com';
  static String telefone = '(12) 99999-1234';
  static String endereco = 'Jardim Satélite, São José dos Campos - SP';
